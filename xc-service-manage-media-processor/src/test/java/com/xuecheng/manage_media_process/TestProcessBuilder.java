...
public class TestProcessBuilder {
    ...
    public void s(){
        ...
        mediaFile.setFileOriginalName("solr.avi");
        List<MediaFile> all = mediaFileRepository.findAll(Example.of(mediaFile) );
...
//        processBuilder.command("ipconfig");
    ...
    public void testFFmpeg() throws IOException {
        ...
        command.add("-i");
        command.add("C:\\Users\\Administrator\\Desktop\\c5c75d70f382e6016d2f506d134eee11.avi");
